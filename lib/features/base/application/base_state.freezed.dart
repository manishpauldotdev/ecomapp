...
abstract class _$$BaseStateImplCopyWith<$Res>
  ...
  factory _$$BaseStateImplCopyWith(
    _$BaseStateImpl value,
    $Res Function(_$BaseStateImpl) then,
...
class __$$BaseStateImplCopyWithImpl<$Res>
  ...
  __$$BaseStateImplCopyWithImpl(
    _$BaseStateImpl _value,
    $Res Function(_$BaseStateImpl) _then,
  ) : super(_value, _then);
...
class _$BaseStateImpl extends _BaseState {
  const _$BaseStateImpl({this.pageIndex = 0}) : super._();
  ...
  @override
  String toString() {
    return 'BaseState(pageIndex: $pageIndex)';
  }
...
abstract class _BaseState extends BaseState {
  const factory _BaseState({final int pageIndex}) = _$BaseStateImpl;
